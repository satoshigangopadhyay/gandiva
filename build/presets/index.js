...
const getLeftistSentence_1 = __importDefault(require("../functions/getLeftistSentence"));
// Constants:
const PRESETS = [
    {
        optionsSet: [
            [
                (0, strict_uri_encode_1.default)('Yes').replace(/%20/g, '+'),
                (0, strict_uri_encode_1.default)('Yes').replace(/%20/g, '+'),
                (0, strict_uri_encode_1.default)('Yes').replace(/%20/g, '+'),
                (0, strict_uri_encode_1.default)('No').replace(/%20/g, '+')
            ],
            [1, 1, 1, 2, 2, 3],
            [
                (0, strict_uri_encode_1.default)('$5: Supporter Tier. Minimum donation per magazine for shipping out magazines and the labor put into Censorship.').replace(/%20/g, '+'),
                (0, strict_uri_encode_1.default)('$6 - $10: Well-Wisher Tier. Donating $6 - $10 per magazine to help us compensate the folks who share their stories, space, and time with us').replace(/%20/g, '+'),
                (0, strict_uri_encode_1.default)('$10 - $15: Companion Tier. Donating $10 - $15 per magazine in support of our podcast creation, and our live and recorded events.').replace(/%20/g, '+'),
                (0, strict_uri_encode_1.default)('$16 - $20: Friend Tier. Donating in support of our SWANASA Stories Anthology project and our body of diverse contributors from all around the world!').replace(/%20/g, '+'),
                (0, strict_uri_encode_1.default)('$21 - $50: Cheerleader Tier. Donating in support of our Black and Dalit centered reparations fund.').replace(/%20/g, '+'),
                (0, strict_uri_encode_1.default)('$50+ : Co-Conspirator Tier. Donating supporting all the above and more; as a student-run organization, we constantly are supporting efforts to grow and learn. By donating, you are helping support our expanding efforts to expand Other Collective worldwide.').replace(/%20/g, '+')
            ]
        ],
        params: {
            data: (fakeCredentials, chosenOption) => `entry.1884265043=${fakeCredentials.name}&entry.1627921496=${fakeCredentials.address}&entry.1990086293=${fakeCredentials.email}&entry.1212348438=${chosenOption[1]}&entry.1195494698=${chosenOption[0]}&entry.99288464=${chosenOption[2]}&entry.513669972=Yes&entry.1195494698_sentinel=&entry.1212348438_sentinel=&entry.99288464_sentinel=&entry.513669972_sentinel=&fvv=1&partialResponse=%5Bnull%2Cnull%2C%22802096517564937586%22%5D&pageHistory=0&fbzx=802096517564937586`,
    ...
    },
    {
        optionsSet: [
            [
                ...
                (0, strict_uri_encode_1.default)('Yes').replace(/%20/g, '+'),
                (0, strict_uri_encode_1.default)('No').replace(/%20/g, '+'),
                (0, strict_uri_encode_1.default)('I would prefer another messaging platform.').replace(/%20/g, '+')
            ],
            [
                (0, strict_uri_encode_1.default)('$5: Supporter Tier. Minimum donation per magazine for shipping out magazines and the labor put into Censorship.').replace(/%20/g, '+'),
                (0, strict_uri_encode_1.default)('$6 - $10: Well-Wisher Tier. Donating $6 - $10 per magazine to help us compensate the folks who share their stories, space, and time with us').replace(/%20/g, '+'),
        ...
        params: {
            data: (fakeCredentials, chosenOption) => `entry.1884265043=${fakeCredentials.name}&entry.1299310772=${fakeCredentials.email}&entry.1195494698=${chosenOption[0]}&entry.99288464=${chosenOption[1]}&entry.513669972=Yes&entry.1195494698_sentinel=&entry.99288464_sentinel=&entry.513669972_sentinel=&fvv=1&partialResponse=%5Bnull%2Cnull%2C%224611978543640427450%22%5D&pageHistory=0&fbzx=4611978543640427450`,
    ...
    null,
    {
        optionsSet: [
            [
                (0, strict_uri_encode_1.default)('Indian Occupied Kashmir').replace(/%20/g, '+'),
                (0, strict_uri_encode_1.default)('India').replace(/%20/g, '+'),
                (0, strict_uri_encode_1.default)('India').replace(/%20/g, '+'),
                (0, strict_uri_encode_1.default)('India').replace(/%20/g, '+'),
                (0, strict_uri_encode_1.default)('Other').replace(/%20/g, '+')
            ]
        ],
        params: {
            data: (fakeCredentials, chosenOption) => `entry.360475397=${fakeCredentials.firstName}&entry.867153817=${fakeCredentials.lastName}&entry.400424234=${fakeCredentials.email}&entry.591877433=${[(0, strict_uri_encode_1.default)((0, getLeftistSentence_1.default)()).replace(/%20/g, '+'), (0, strict_uri_encode_1.default)((0, getLeftistSentence_1.default)()).replace(/%20/g, '+'), (0, strict_uri_encode_1.default)((0, getLeftistSentence_1.default)()).replace(/%20/g, '+') + '+' + (0, strict_uri_encode_1.default)((0, getLeftistSentence_1.default)()).replace(/%20/g, '+')][Math.floor(Math.random() * 3)]}&entry.2081813454=${chosenOption[0]}&dlut=1637939379864&entry.2081813454_sentinel=&fvv=1&partialResponse=%5Bnull%2Cnull%2C%22-7713807496820752134%22%5D&pageHistory=0&fbzx=-7713807496820752134`,
